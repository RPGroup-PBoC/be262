...
* Day 2 - Wed, 2nd September : Looking at constitutive gene expression, and its master equation. In this tutorial, we also reviewed some fundamental coding syntax. You can find a code template [here](https://colab.research.google.com/drive/1PrEvo1SBdZuiTI6-ygUejvi85bpfXylm?usp=sharing). {% comment %}
