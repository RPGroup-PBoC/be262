...
* Day 4: Spread the butter \| \| <a href="{{site.baseurl}}/code/2021/diffusion_masterequation.html" target="_blank" style="font-size: 17px">
  Notebook
  </a>

* Day 5: Probability distributions of mRNA counts in yeast \| [Mdn1](http://rpdata.caltech.edu/courses/course_data/mRNA_MDN1.csv) and [Pdr5](http://rpdata.caltech.edu/courses/course_data/mRNA_PDR5.csv), adapted from this [paper](https://www.nature.com/articles/nsmb.1514). \| <a href="{{site.baseurl}}/code/2021/diffusion_via_coin_flips_continued.pdf" target="_blank" style="font-size: 17px">
  Notebook 1
