...
* [Tutorial 0c: A Primer on Python Syntax]({{ site.baseurl }}/code/t0a_setting_up_python.html) \| This tutorial will walk you through the basics of programming in Python.


## Data sets
Please download the following data sets, unzip them, and place them in your `pboc/data` folder as described in [the setting up Python tutorial]({{ site.baseurl }}/code/t0c_python_syntax_and_plotting.html).
