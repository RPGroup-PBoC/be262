...
* [Exercise 9]({{ site.baseurl}}/code/taylor_series.html) \| Plotting Taylor series approximations for increasing number of terms. \[[In class]({{ site.baseurl}}/code/taylor_series_in_class.html)\]

* [Exercise 13]({{ site.baseurl}}/code/inferring_p_heads.html) \| Using Bayesian inference to predict the probability of getting heads on an unfair coin.
