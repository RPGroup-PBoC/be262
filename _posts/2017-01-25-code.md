...
* [Exercise 5]({{ site.baseurl}}/code/diffusion_1d_and_FRAP.html) \| Continuation of our stochastic treatment of diffusion. \[[In class]({{ site.baseurl}}/code/diffusion_1d_and_FRAP_in_class.html)\]
