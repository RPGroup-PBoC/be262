...
* [Exercise 6]({{ site.baseurl}}/code/lacI_titration_day1.html) \| Making segmentation masks for our gene expression project. \[[Data set](http://rpdata.caltech.edu/courses/course_data/lacI_titration.zip)\] \[[In class]({{ site.baseurl}}/code/lacI_titration_day1._in_class.html)\]
