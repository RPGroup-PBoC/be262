...
* [Exercise 3]({{ site.baseurl}}/code/diffusion_via_coin_flips.html) \| Numerically integrating the differential equation for exponential growth. \[[In class]({{ site.baseurl}}/code/diffusion_via_coin_flips_in_class.html)\]
